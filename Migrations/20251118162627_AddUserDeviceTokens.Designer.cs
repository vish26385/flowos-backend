...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowOS.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FlowOS.Api.Models.Audit.AiPlanAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlowOS.Api.Models.DailyPlanItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlowOS.Api.Models.NudgeFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlowOS.Api.Models.UserDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlowOS.Api.Models.DailyPlan", b =>
                {
                    b.HasOne("FlowOS.Api.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FlowOS.Api.Models.DailyPlanItem", b =>
                {
                    b.HasOne("FlowOS.Api.Models.DailyPlan", "Plan")
                        .WithMany("Items")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlowOS.Api.Models.Task", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("FlowOS.Api.Models.NudgeFeedback", b =>
                {
                    b.HasOne("FlowOS.Api.Models.DailyPlanItem", "PlanItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FlowOS.Api.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
